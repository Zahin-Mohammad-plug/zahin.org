  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-30">
      ...
      >
        ...
        {/* Use fixed positioning to ensure full viewport coverage when zoomed */}
        <div 
          className="fixed"
          style={{
            left: 0,
            ...
            width: '100vw',
            height: '100vh',
            animation: "galaxy-scroll 3.2s ease-out forwards",
        ...
        <div 
          ...
          style={{
            animation: "fade-out-gradient 3.2s ease-out forwards",
          }}
        />
      </div>
    </div>
